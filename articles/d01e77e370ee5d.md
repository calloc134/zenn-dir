---
title: "ブート画面にCLI起動エントリを追加しよう(Manjaro)"
emoji: "🐧"
...
https://github.com/manjaro-sway/iso-profiles
...
if [ "x${GRUB_DISTRIBUTOR}" = "x" ] ; then
  ...
  OS="${GRUB_DISTRIBUTOR} Linux GUI Version"
...
ここで、`linux_entry` に渡される引数の末尾に `systemd.unit=multi-user.target` を追加します。
