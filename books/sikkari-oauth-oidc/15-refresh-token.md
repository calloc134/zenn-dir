...
**リフレッシュトークン**は、アクセストークンを再発行するためのトークンです。[^rfc6749-refresh-token]

[^rfc6749-refresh-token]: RFC 6749 Section 1.5 では「リフレッシュトークンは, アクセストークンを取得するために使用されるクレデンシャルである」と説明されています。https://www.rfc-editor.org/rfc/rfc6749.html#section-1.5
