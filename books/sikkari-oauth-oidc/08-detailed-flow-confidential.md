...
先ほどのリダイレクト指示により、リソースオーナーのブラウザは認可サーバにアクセスします。このリクエストを**認可リクエスト**と呼びます。
...
認可サーバは、リソースオーナーをクライアントの `redirect_uri` にリダイレクトさせます。このレスポンスを**認可レスポンス**と呼びます。
...
クライアントは、認可コードを使って認可サーバにアクセストークンをリクエストします。このリクエストを**トークンリクエスト**と呼びます。
