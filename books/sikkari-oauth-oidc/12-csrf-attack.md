...
![](/images/12-csrf-attack/2025-12-02-19-03-32.png)
...
| 検証内容       | フォームにアクセスしたユーザセッションとフォーム送信したユーザセッションの一致 | フローを開始しようとしたユーザセッションと認可コードを返却したユーザセッションの一致 |
...
| 一致検証する対象 | 認可コードリクエストしたクライアント＝トークンリクエストしたクライアント | フローを開始した際のユーザセッション＝認可コードを渡したユーザセッション |
