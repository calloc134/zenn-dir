...
リソースオーナーは、認可サーバに働きかけて認可をもらいました。
今度は、認可が降りたということをクライアントに伝えます。
...
リソースオーナーがクライアントに認可を伝えると、クライアントは鍵を取得しようとします。
...
「認可コードを挟むステップのせいで煩雑になっている」と感じるかもしれませんが、これはセキュリティ向上のために必要なステップです。
