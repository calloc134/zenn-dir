---
title: "認可コードを用いてアクセストークンを不正に取得する攻撃と防御 (PKCE)"
free: true
---
...
の 2 つ、
つまり**一つのフローにおけるクライアント**に一貫性があることを、
**認可サーバ**が検証する仕組みです。
...
PKCE は、**一つのフローにおけるクライアントの一貫性を保証する**仕組みです。
...
クライアントの一貫性という言葉を利用しましたが、
今回の攻撃ではクライアント自体はどちらも正規のものです。

重要なのは、**フローを開始したクライアント** と、
**フロー内でアクセストークンを取得しようとするクライアントが同一であること**です。
クライアント自体が正しくても、フローが異なれば別のものとして扱われます。

:::

![](/images/11-token-theft-attack/2025-12-25-17-56-39.png)
...
![](/images/11-token-theft-attack/2025-12-03-11-56-11.png)
...
![](/images/11-token-theft-attack/2025-12-03-12-00-08.png)
...
![](/images/11-token-theft-attack/2025-12-03-12-08-00.png)
...
![](/images/11-token-theft-attack/2025-12-03-12-10-39.png)
